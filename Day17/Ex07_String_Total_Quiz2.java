...
//내가 풀어본 문제
	 ...
	 * }
	 * 
	 * public class Ex07_String_Total_Quiz2 { public static void main(String[] args)
	 * { String ssn=""; String regNum[]=new String[14]; do { Scanner sc= new
	 * Scanner(System.in); System.out.println("주민번호 입력 :"); ssn= sc.next();
	 * if(ssn.length()==14) { //문자열의 길이가 14일때는 배열안에 값을 받아서 "-"를 ""로 replace 한다음에
